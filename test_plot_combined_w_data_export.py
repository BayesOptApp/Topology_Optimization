    ...
    for exp_type in exp_types:
        ...
        for alg in algorithms:
            ...
            if exp_type == "Sequential":
                ...
                dt_2 = turbo_align(dt_2, np.arange(1, 168), y_col="current_y", maximization=False)
            ...
            # Save stats to CSV
            export_folder = ROOT_FOLDER / "convergence_data"
            export_folder.mkdir(exist_ok=True)
            filename = f"{alg}_{exp_type}_{material}.csv".replace("-", "_")
