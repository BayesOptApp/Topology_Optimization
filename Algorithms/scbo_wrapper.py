...
from .Turbo_utils.turbo_utils import ScboState, update_tr_length, get_best_index_for_batch, update_state
...
class SCBO_Wrapper:
    ...
    def ioh_prob(self, ioh_prob:Union[Design_IOH_Wrapper,
        ...
        """
        if not isinstance(ioh_prob, (Design_IOH_Wrapper, Design_LP_IOH_Wrapper, Design_IOH_Wrapper_Instanced, ioh.iohcpp.problem.RealSingleObjective)):
    ...
    def __call__(self,
        ...
        while n_evals<=total_budget:
            ...
            state = ScboState(self.dim, batch_size=self.batch_size,
