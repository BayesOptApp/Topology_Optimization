...
from boundary_conditions.point_neumann_bc import PointNeumannBC
from meshers.MeshGrid2D import MeshGrid2D

class LineNeumannBC(PointNeumannBC):
    """
    Represents a Neumann boundary condition applied along a line segment.
    """

    def __init__(self, 
                 start_point:Tuple[float,float], 
                 end_point:Tuple[float,float], 
                 force_vector:Tuple[float,...])->None:
        r"""
        ...
        Args:
            ...
            force_vector (tuple): Force vector applied along the line in (fx, fy) format.
                                  Note that this assumes a uniform force vector along the line segment.
        """
        ...
        super().__init__(location=[start_point, end_point], force_vector=force_vector)
